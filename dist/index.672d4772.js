...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const activateDot = function(slide) {
        document.querySelectorAll(".dots__dot").forEach((dot)=>dot.classList.remove("dots__dot--active")); //usuwamy ze wszytkich active class
        document.querySelector(`.dots__dot[data-slide="${slide}"]`) //dodajemu active w odpowiednie miejsce
